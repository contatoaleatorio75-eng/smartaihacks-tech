...
def test_scene_0():
    i = 0
    audio_path = os.path.join("output", "audio", "scene_000.mp3")
    image_path = os.path.join("output", "assets", "scene_001.jpg")
    output_path = os.path.join("output", "temp_scenes", "scene_000_test.mp4")
    ...
    sub = create_subtitle_clip("Se inscreva no canal AlêAtório para não perder nenhum vídeo!", (1080, 1920), audio_clip.duration)
    cta = create_cta_overlay("INSCREVA-SE NO CANAL ALÊATÓRIO!", (1080, 1920), audio_clip.duration)
